...
class PeopleSpider(CrawlSpider):
    ...
    def parse_article(self, response):
        ...
        hb_div = sel.xpath('//div[@class="main"]/div[@class="le"]')

        p_detail_div = sel.xpath('//div[@id="p-detail"]')
        ...
        if news_1_div:
            ...
            news_item = get_hb_news_div(response)

            yield news_item
        elif p_detail_div:
            news_item = get_p_detail_div(response)
