...
# Scrapy settings for gmwSpider project
#
...
SPIDER_MODULES = ['gmwSpider.spiders']
NEWSPIDER_MODULE = 'gmwSpider.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'gmwSpider.middlewares.rotate_useragent.RotateUserAgentMiddleware': 543,
}
...
ITEM_PIPELINES = {
    ...
    'gmwSpider.pipelines.SaveToMysqlPipeline': 400,
}
...
# 日志
LOG_LEVEL = 'INFO'
LOG_FILE = 'gmwSpider/logs/scrapy.log'
LOG_STDOUT = True
