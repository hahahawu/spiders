...
# Scrapy settings for xinwen110Spider project
#
...
BOT_NAME = 'xinwen110Spider'

SPIDER_MODULES = ['xinwen110Spider.spiders']
NEWSPIDER_MODULE = 'xinwen110Spider.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'xinwen110Spider.middlewares.rotate_useragent.RotateUserAgentMiddleware': 543,
}
...
ITEM_PIPELINES = {
    # 'xinwen110Spider.pipelines.ImagePipeline': 300,
    'xinwen110Spider.pipelines.SaveToMysqlPipeline': 400,
}
...
# 日志
# LOG_LEVEL = 'INFO'
# LOG_FILE = 'xinwen110Spider/logs/scrapy.log'
# LOG_STDOUT = True
